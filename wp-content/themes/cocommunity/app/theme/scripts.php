...
function govsite_scripts_wp_enqueue_scripts() {
  ...
  wp_enqueue_script('main', get_stylesheet_directory_uri() . '/../build/main.min.js', array('jquery', 'modernizr'), '', true);
    //wp_enqueue_script('main', get_stylesheet_directory_uri() . '/../build/main.js', array('jquery', 'modernizr'), '', true);
  ...
  wp_enqueue_style ('user_css', get_stylesheet_directory_uri() . '/style.css');
