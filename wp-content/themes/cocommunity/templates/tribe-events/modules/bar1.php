...
<form id="events-bar-form" name="tribe-bar-form" method="post" action="<?php echo esc_attr( $current_url ); ?>">
	<div id="buddypress">
		<div id="events-search-wrap" class="dir-search" role="search">
			<label for="events-bar-search">
				<input type="text" name="tribe-bar-search" id="events-bar-search" value="<?php echo esc_attr( $value ); ?>" placeholder="<?php echo esc_attr__( 'Search', 'the-events-calendar' ); ?>">
			</label>
